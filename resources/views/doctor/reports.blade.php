...
<a href="{{ url('doctor/dashboard') }}" class="follow-btn mx-3">Go Back</a>

<div class="d-flex justify-content-end mx-2">
    <a style="align-items: left;" href="{{ route('addReport') }}" class="follow-btn btn-primary">+ Add New Report</a>
</div>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    {{-- <td>{{ App\Models\Plan::where('id',$report->plan_id)->first()->title?? '' }}</td> --}}
                    ...
                    {{-- <td>{{ App\Models\Review::where('reviewable_type','patient')->where('reviewable_id',$report->patient_id)->first()->comment?? 'no comment yet' }}</td> --}}
<td>
    <a href="{{ route('editReport',['report_id'=>$report->id]) }}" class="btn btn-secondary btn-sm m-2">Edit the report</a>
</td>
                </tr>
                @endforeach
            </tbody>
