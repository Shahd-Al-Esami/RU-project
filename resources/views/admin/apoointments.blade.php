            ...
            @else
                ...
                @foreach($appointments as $appointment)
                    <li class="list-group-item mt-3">
                        <strong>Patient :</strong> {{ App\Models\User::where('id',$appointment->patient_id)->first()->name ?? '' }},

                        <strong>Doctor :</strong> {{ App\Models\User::where('id',$appointment->doctor_id)->first()->name ??'' }},
