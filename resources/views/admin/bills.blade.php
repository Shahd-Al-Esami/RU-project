...
<div class="container">
    <h2 style="text-align: center">All Bills Of Doctors</h2>
        <!-- حقل البحث -->
        <div class="container mb-4">
            <form method="GET" action="">
                <div class="input-group">
                    {{-- <input type="text" id="search" name="doctor_id" value="{{ request('doctor_id') }}" placeholder="Search by Patient Name"> --}}

                    <select name="doctor_id" id="doctor_id">
                        <option value=""> Select Doctor Name</option>
                        @foreach(App\Models\User::where('role','doctor')->where('isAgreeDoctorRegistration','agree')->get() as $doctor)
                    ...
                    <input class="mx-3" type="date" id="search" name="date" value="{{ request('date') }}" placeholder="Select a date">
        ...
        <table class="table table-bordered mt-5">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ App\Models\User::where('id',$bill->doctor_id)->first()->name??'' }}</td>
