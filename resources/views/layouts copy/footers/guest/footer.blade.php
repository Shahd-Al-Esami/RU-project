...
<footer class="footer py-5" style="background: rgba(255, 255, 255, 0.0); background: linear-gradient(180deg, rgba(255, 255, 255, 0.0), rgb(231 138 0));">
    <div class="container">
        <div class="row">
            ...
            <div class="row" style = "opacity : 1">
                <div class="col-8 mx-auto text-center mt-1">
                    <p class="mb-0 text-secondary">
                        ...
                        <a style="color: #252f40;" href="https://www.programecho.com" class="font-weight-bold ml-1" target="_blank">ProgramEcho</a>
                        &
                        <a style="color: #252f40;" href="https://www.updivision.com" class="font-weight-bold ml-1" target="_blank">Damascuse University</a>.
                    </p>
                </div>
            </div>
        @endif
