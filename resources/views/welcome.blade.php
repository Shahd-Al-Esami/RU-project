    ...
    <body class="antialiased">
        ...
        <h1 style="font-family:cursive;font-size:25px;margin-left: 20px;"><b>HealthBite</b></h1>
            @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                    @auth
                        ...
                        @else
                        {{-- (Route::has('register')) --}}
                            <a href="{{ route('register') }}" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500" style="font-size: 20px;">Sign Up</a>
                        {{-- @endif --}}
                    @endauth
            ...
            <main class="main-content" style="margin-top:200px;">
                <section class="" style="margin-left:800px;">
                   <div class="page-header min-vh-75" style="position: relative;z-index:0;">
                    <div class="container">
                      <div class="row justify-content-center ">
                        <div class="col-xl-6 col-lg-6 col-md-6" style="margin-left:200px;">
                          <div class="card card-plain mt-8" style="background: url(../assets/img/loginformback.jpg); backface-visibility: hidden; background-size:cover; background-position-x: center; padding: 85px; position: relative; background-repeat: no-repeat;">
                            <div class="card-header pb-0 text-left bg-transparent">
                              <h3 class="font-weight-bolder text-info text-gradient" style="background-image: linear-gradient(310deg, #b54500, #0404049c);">Welcome..</h3>
                            </div>
                            <div class="card-body">
