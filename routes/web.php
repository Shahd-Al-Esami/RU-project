...
Route::get('/doctor/dashboard', [HomeController::class, 'doctorDash'])->name('doctor.dashboard'); // وجهة الطبيب
...
Route::get('/getAllDoctors',[UserController::class,'getAllDoctors'])->middleware('auth')->name('getAllDoctors');
